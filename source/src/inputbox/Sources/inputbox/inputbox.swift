// swift build --package-path ./src/inputbox -Xswiftc "-target" -Xswiftc "x86_64-apple-macosx10.15" -Xlinker -rpath -Xlinker @executable_path/Frameworks
...
struct ContentView: View {
    @State private var textField_text: String = options["initial_text"] as! String;
    var body: some View {
        VStack(spacing: 0) {
            HeaderView()
            BodyView(textField_text: $textField_text)
            FooterView(textField_text: $textField_text)
        }
        .padding(5)
    }
}
...
struct BodyView: View {
    @Binding var textField_text: String;
    var body: some View {
        HStack(alignment: .top) {
            if (options["icon_type"] as! String != "none") {
                IconView()
            }
            MainView(textField_text: $textField_text)
        }
...
struct MainView: View {
    ...
    var body: some View {
        VStack {
            ...
            TextFieldView(textField_text: $textField_text)
        }
...
struct TextFieldView: View {
    ...
    var body: some View {
        VStack() {
            TextField(options["background_text"] as! String, text: $textField_text) 
...
struct FooterView: View {
    ...
    var body: some View {
        HStack() {
            ...
            ButtonsView(textField_text: $textField_text)
        }
    }
}
