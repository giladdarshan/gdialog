// swift build --package-path ./src/textbox -Xswiftc "-target" -Xswiftc "x86_64-apple-macosx10.15" -Xlinker -rpath -Xlinker @executable_path/Frameworks
...
struct MainView: View {
    ...
    var body: some View {
        VStack {
            ...
            TextEditorView(textField_text: $textField_text)
        }
    ...
    var body: some View {
        VStack() {
            if #available(macOS 10.16, *) {
                TextEditor(text: $textField_text)
                .font(.body)
                .multilineTextAlignment(.leading)
