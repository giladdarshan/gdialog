// swift build --package-path ./src/secure-inputbox -Xswiftc "-target" -Xswiftc "x86_64-apple-macosx10.15" -Xlinker -rpath -Xlinker @executable_path/Frameworks
...
// Variables - Defaults
var gdialog_type = "secure-inputbox";
...
struct ContentView: View {
    @State private var textField_text: String = "";
    var body: some View {
        VStack(spacing: 0) {
            HeaderView()
...
struct MainView: View {
    ...
    var body: some View {
        VStack {
            ...
            SecureFieldView(textField_text: $textField_text)
        }
...
struct SecureFieldView: View {
    ...
    var body: some View {
        VStack() {
            SecureField(options["background_text"] as! String, text: $textField_text)
